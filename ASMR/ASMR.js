...
export const recipeSteps = [
  "1. 무를 1.3cm 두께 정도로 반달썰기합니다. 얇으면 무가 흐물흐물해지기 때문에 적당한 크기여야 합니다. (소요시간 1분)",
  "2. 대파와 고추를 1cm 두께 정도로 어슷썰기합니다. 대파와 고추도 얇으면 흐물흐물해지기 때문에 적당한 크기여야 합니다. (소요시간 2분)",
  "3. 간장, 고춧가루, 설탕 및 양념장 재료들을 섞어 양념장을 만듭니다. 양념장 재료는 취향에 따라 바꾸어도 됩니다. (소요시간 4분)",
  "4. 고등어를 깨끗하게 헹굽니다. 깨끗이 행구지 않으면 비린내가 날 수도 있으며, 비브리오 균이 들어올 수도 있습니다. (소요시간 6분)",
  "5. 헹군 고등어를 반으로 자릅니다. 반으로 자르고 더 자르는건 상관없습니다. (소요시간 2분)",
  "6. 냄비에 무를 깔아놓고 반으로 자른 고등어를 얹습니다. 얹는 모양은 예쁘게 하는 것이 보기에 좋습니다. (소요시간 5분)",
  "7. 대파와 고추를 냄비에 얹은 고등어에 올립니다. 이 단계 또한 얹을 때 예쁘게 하는 것이 보기에 좋습니다.(소요시간 1분)",
  "8. 양념장을 냄비에 붓고 뚜껑을 열고 끓입니다. 끓이는 동안은 자유롭게 할 것 하면 됩니다. (소요시간 10분)",
  "9. 거품이 지어 끓어오르면 불을 줄이고 뚜껑을 닫습니다. 불을 줄이지 않으면 탄맛이 날 수 있습니다. (소요시간 3분)",
